			...
			<form action="ServletLogin" method="post"
				...
				<table>
					<ul class="nav navbar-nav " style="border-bottom:#517fa4 2px">
						<li>轨道交通信号设备健康管理系统</li>
					</ul>
					<tr>
						<td><input class="input" type="text" name="ID" placeholder="请输入账号">
						</td>
					</tr>
					<tr>
						<td><input class="input" type="password" name="pwd" placeholder="请输入密码">
						</td>
					</tr>
					<tr>
						<td>
							<input class="check" type="radio" name="role" value="0" checked="checked">学生
							<input class="check" type="radio" name="role" value="1">管理员
						</td>
					</tr>
					<tr>
						<td>
