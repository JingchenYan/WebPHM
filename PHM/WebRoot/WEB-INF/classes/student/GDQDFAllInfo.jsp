...
<body>
<form action="stu.ServletSearchGDQDF" method="post" id="frm">
	<div class="div_list">
		设备名称：<input type="text" class="form-control form1"   name="GDQDFName" value="${gdqdf.getGDQDFName()}" />&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="submit" class="btn btn-primary" value="查询" />
	</div>
</form>
<form action="stu.ServletFindAllGDQDF" method="post" id="frm1">
