...
<body>
<form action="ServletSearchLSXTF" method="post" id="frm">
	<div class="div_list">
		设备名称：<input type="text" class="form-control form1"   name="LSXTFName" value="${lsxtf.getLSXTFName()}" />&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="submit" class="btn btn-primary" value="查询" />
	</div>
</form>
<form action="ServletFindAllLSXTF" method="post" id="frm1">
	<div class="div_list1 panel panel-default">
		...
		<table class="table panel-body" id="tableClass">
			...
			<c:forEach var="list" items="${list.pbjs }">
				<tr>
					<td>${list.getLSXTFName() }</td>
					<td>${list.getLSXTFDate() }</td>
					<td style="width: 500px;">${list.getLSXTFault() }</td>
					<td><a href="ServletSelectLSXTF?LSXTFID=${list.getLSXTFID() }">修改</a>&nbsp;&nbsp;&nbsp;<a href="ServletDeleteLSXTF?LSXTFID=${list.getLSXTFID() }" onclick="return confirm('是否确认删除？')">删除</a></td>
