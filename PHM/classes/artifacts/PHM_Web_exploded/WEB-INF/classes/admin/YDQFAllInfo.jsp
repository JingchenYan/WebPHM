...
<body>
<form action="ServletSearchYDQF" method="post" id="frm">
	<div class="div_list">
		设备名称：<input type="text" class="form-control form1"   name="YDQFName" value="${ydqf.getYDQFName()}" />&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="submit" class="btn btn-primary" value="查询" />
	</div>
</form>
<form action="ServletFindAllYDQF" method="post" id="frm1">
	<div class="div_list1 panel panel-default">
		...
		<table class="table panel-body" id="tableClass">
			...
			<c:forEach var="list" items="${list.pbjs }">
				<tr>
					<td>${list.getYDQFName() }</td>
					<td>${list.getYDQFDate() }</td>
					<td style="width: 500px;">${list.getYDQFault() }</td>
					<td><a href="ServletSelectYDQF?YDQFID=${list.getYDQFID() }">修改</a>&nbsp;&nbsp;&nbsp;<a href="ServletDeleteYDQF?YDQFID=${list.getYDQFID() }" onclick="return confirm('是否确认删除？')">删除</a></td>
