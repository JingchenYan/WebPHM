...
<html>
  <head>
    ...
    <title>My JSP 'selectDC.jsp' starting page</title>
...
function page(s){
  ...
  <form action="ServletSearchDC" method="post" id="frm">
	  <div class="div_list">
		  设备名称：<input type="text" class="form-control form1"   name="DCName" value="${param.DCName}" />&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<table class="table panel-body" id="tableClass">
				...
				<c:forEach var="list" items="${list.pbjs }">
					<tr>
						...
						<td><a href="ServletSearchDCF?DCFName=${list.getDCName() }">查看</a></td>
						<td><a href="ServletSelectDC?DCID=${list.getDCID() }">修改</a>&nbsp;&nbsp;&nbsp;<a href="ServletDeleteDC?DCID=${list.getDCID() }" onclick="return confirm('是否确认删除？')">删除</a></td>
