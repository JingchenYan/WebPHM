...
function page(s){
  ...
  <form action="stu.ServletSearchXHJ" method="post" id="frm">
	  <div class="div_list">
		  设备名称：<input type="text" class="form-control form1"   name="XHJName" value="${param.XHJName}" />&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<table class="table panel-body" id="tableClass">
				...
				<c:forEach var="list" items="${list.pbjs }">
					<tr>
						...
						<td><a href="stu.ServletSearchXHJF?XHJFName=${list.getXHJName() }">查看</a></td>
