			...
			<ul class="nav">
				<li>
					...
					<ul id="menu-info" class="collapse">
						<li><a href="ServletselectPwd" target="mainRight">查询账号信息</a></li>
				...
				<li>
					...
					<ul id="menu-XHJ" class="collapse">
						<li><a href="stu.ServletFindAllXHJ" target="mainRight">设备信息</a></li>
						<li><a href="stu.ServletFindAllXHJF" target="mainRight">故障信息</a></li>
					</ul>
				</li>
				...
				<li>
					...
					<ul id="menu-DC" class="collapse">
						<li><a href="stu.ServletFindAllDC" target="mainRight">设备信息</a></li>
						<li><a href="stu.ServletFindAllDCF" target="mainRight">故障信息</a></li>
					</ul>
				</li>
				...
				<li>
					...
					<ul id="menu-GDQD" class="collapse">
						<li><a href="stu.ServletFindAllGDQD" target="mainRight">设备信息</a></li>
						<li><a href="stu.ServletFindAllGDQDF" target="mainRight">故障信息</a></li>
					</ul>
				</li>
				...
				<li>
					...
					<ul id="menu-YDQ" class="collapse">
						<li><a href="stu.ServletFindAllYDQ" target="mainRight">设备信息</a></li>
						<li><a href="stu.ServletFindAllYDQF" target="mainRight">故障信息</a></li>
					</ul>
				</li>
				...
				<li>
					...
					<ul id="menu-LSXT" class="collapse">
						<li><a href="stu.ServletFindAllLSXT" target="mainRight">设备信息</a></li>
						<li><a href="stu.ServletFindAllLSXTF" target="mainRight">故障信息</a></li>
					</ul>
				</li>
				...
				<li>
					...
					<ul id="menu-CTC" class="collapse">
						<li><a href="stu.ServletFindAllCTC" target="mainRight">设备信息</a></li>
						<li><a href="stu.ServletFindAllCTCF" target="mainRight">故障信息</a></li>
					</ul>
				</li>
			</ul>
		</div>
